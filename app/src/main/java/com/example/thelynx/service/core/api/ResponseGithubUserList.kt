package com.example.thelynx.service.core.api
...
class GithubUserList : ArrayList<UserList>()

@Entity(tableName = "favourite_table")
data class UserList(
    @PrimaryKey @ColumnInfo(name = "node_id") var node_id: String,
    ...
    @ColumnInfo(name = "clickLike") var clickLike: Boolean
)
